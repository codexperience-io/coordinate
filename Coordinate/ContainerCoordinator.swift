...
open class ContainerCoordinator<T: UIViewController>: Coordinator<T>, Coordinating  {
    ...
    private(set) public var childCoordinators: [String: Coordinated] = [:]
     ...
     */
    public func addChild(coordinator: Coordinated) {
     ...
     */
    public func startChild(coordinator: Coordinated, completion: @escaping () -> Void = {}) {
     ...
     */
    public func stopChild(coordinator: Coordinated, completion: @escaping () -> Void = {}) {
    ...
    public func startOrActivateChild(coordinator: Coordinated) {
    ...
    open func show(_ coordinator: Coordinated, sender: Any?) {
        startOrActivateChild(coordinator: coordinator)
        rootViewController.show(coordinator.getRootViewController(), sender: sender)
    }
    
    open func present(_ coordinator: Coordinated, animated: Bool, completion: (() -> Void)?) {
        startOrActivateChild(coordinator: coordinator)
    ...
    */
    open func root(_ coordinator: Coordinated, animated: Bool = false, completion: (() -> Void)? = nil) {
        startOrActivateChild(coordinator: coordinator)
